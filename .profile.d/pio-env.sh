...
export PIO_STORAGE_SOURCES_ELASTICSEARCH_TYPE="${PIO_STORAGE_SOURCES_ELASTICSEARCH_TYPE-elasticsearch}"
...
export PIO_STORAGE_SOURCES_ELASTICSEARCH_HOME="/app/pio-engine/PredictionIO-dist/vendors/elasticsearch"
